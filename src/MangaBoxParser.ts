...
export class MangaBoxParser {
    parseManga = ($: CheerioAPI, source: MangaBox): PartialSourceManga[] => {
    ...
    parseChapters = (chapterJson: JsonChapters, mangaId: string, source: MangaBox): Chapter[] => {
    ...
    parseChapterDetails = async ($: CheerioAPI, mangaId: string, chapterId: string, source: MangaBox): Promise<ChapterDetails> => {
        const pages: string[] = []
